# Generated by Django 3.1.2 on 2020-10-31 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='newbooking.package')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
            fields=[
                ...
                ('package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='newbooking.package')),
                ('preferred_mode_of_travel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='newbooking.conveyance')),
            ],
        ),
    ]
